...
export default function ShopkeeperTransactionsPage() {
  ...
  const handleShareWhatsApp = () => {
    ...
    setTimeout(() => {
      const message = `Transaction summary for ${shopkeeper.name}. Please attach the PDF file you just saved to this chat. This report was generated by JMD Enterprises.`;
